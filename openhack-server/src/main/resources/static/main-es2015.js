...
const bulkupload_component_1 = __webpack_require__(/*! ./bulkupload/bulkupload.component */ "./src/app/bulkupload/bulkupload.component.ts");
const routes = [
...
const button_1 = __webpack_require__(/*! @angular/material/button */ "./node_modules/@angular/material/esm2015/button.js");
...
const upload_component_1 = __webpack_require__(/*! ./bulkupload/upload/upload.component */ "./src/app/bulkupload/upload/upload.component.ts");
...
const confirm_component_1 = __webpack_require__(/*! ./confirm/confirm.component */ "./src/app/confirm/confirm.component.ts");
const jsonview_component_1 = __webpack_require__(/*! ./bulkupload/jsonview/jsonview.component */ "./src/app/bulkupload/jsonview/jsonview.component.ts");
const ang_jsoneditor_1 = __webpack_require__(/*! ang-jsoneditor */ "./node_modules/ang-jsoneditor/fesm2015/ang-jsoneditor.js");
const errorbar_component_1 = __webpack_require__(/*! ./bulkupload/errorbar/errorbar.component */ "./src/app/bulkupload/errorbar/errorbar.component.ts");
const tooltip_1 = __webpack_require__(/*! @angular/material/tooltip */ "./node_modules/@angular/material/esm2015/tooltip.js");
const errordata_component_1 = __webpack_require__(/*! ./bulkupload/errordata/errordata.component */ "./src/app/bulkupload/errordata/errordata.component.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const validation_service_1 = __webpack_require__(/*! ./bulkupload/validation.service */ "./src/app/bulkupload/validation.service.ts");
const core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
const http_1 = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
let AppService = class AppService {
    constructor(http, validateService) {
        this.http = http;
    ...
    uploadFileData(selectedFilesData, errorData) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const errordata_component_1 = __webpack_require__(/*! ./errordata/errordata.component */ "./src/app/bulkupload/errordata/errordata.component.ts");
const confirm_component_1 = __webpack_require__(/*! ./../confirm/confirm.component */ "./src/app/confirm/confirm.component.ts");
const core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
const app_service_1 = __webpack_require__(/*! ../app.service */ "./src/app/app.service.ts");
const dialog_1 = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
const upload_component_1 = __webpack_require__(/*! ./upload/upload.component */ "./src/app/bulkupload/upload/upload.component.ts");
const sort_1 = __webpack_require__(/*! @angular/material/sort */ "./node_modules/@angular/material/esm2015/sort.js");
const table_1 = __webpack_require__(/*! @angular/material/table */ "./node_modules/@angular/material/esm2015/table.js");
const paginator_1 = __webpack_require__(/*! @angular/material/paginator */ "./node_modules/@angular/material/esm2015/paginator.js");
const snack_bar_1 = __webpack_require__(/*! @angular/material/snack-bar */ "./node_modules/@angular/material/esm2015/snack-bar.js");
const jsonview_component_1 = __webpack_require__(/*! ./jsonview/jsonview.component */ "./src/app/bulkupload/jsonview/jsonview.component.ts");
const errorbar_component_1 = __webpack_require__(/*! ./errorbar/errorbar.component */ "./src/app/bulkupload/errorbar/errorbar.component.ts");
let BulkuploadComponent = class BulkuploadComponent {
    constructor(appService, dialog, changeDetectorRefs, snackBar) {
    ...
    getValidatedFilesData(type) {
        this.appService.getValidatedFilesData().subscribe((response) => {
    ...
    openUploadDialog() {
        ...
        const dialogRef = this.dialog.open(upload_component_1.UploadComponent, dialogConfig);
    ...
    getUpdateDataById(currentElement) {
        ...
        let responseData = {};
        this.appService.getUpdateDataById(validateId).subscribe(data => {
            if (data) {
                responseData = data;
    ...
    deleteValidateFileData(validateFileObj) {
        this.appService.deleteValidateFileData(validateFileObj).subscribe(response => {
            let tempList = [];
    ...
    deleteAllValidateFielData() {
        const dialogRef = this.dialog.open(confirm_component_1.ConfirmComponent, {
            width: '350px',
            data: 'Do you confirm the deletion?'
        });
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.appService.deleteAllValidateFielData().subscribe(response => {
    ...
    showJsonViewer(currentElement) {
        ...
        const dialogRef = this.dialog.open(jsonview_component_1.JsonviewComponent, dialogConfig);
        dialogRef.afterClosed().subscribe(result => {
    ...
    getErrorDetails(currentElement) {
        ...
        const dialogRef = this.dialog.open(errordata_component_1.ErrordataComponent, dialogConfig);
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
        });
    }
...
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
let ItrschemaService = class ItrschemaService {
    constructor() { }
    getITR2Schema() {
        const itr2Schema = {
            definitions: {},
...
const core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
const dialog_1 = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
const validation_service_1 = __webpack_require__(/*! ../validation.service */ "./src/app/bulkupload/validation.service.ts");
let UploadComponent = class UploadComponent {
    constructor(sanitizer, appService, dialogRef, validateService, data) {
    ...
    uploadFiles(filesData) {
        ...
        for (const fileData of filesData) {
            this.validateService.getFinalErrorMessage(fileData, this.data.schemaType).then(data => {
                errordata = data;
                this.appService.uploadFileData(fileData, errordata).subscribe(response => {
                    console.log(response);
...
const itrschema_service_1 = __webpack_require__(/*! ./itrschema.service */ "./src/app/bulkupload/itrschema.service.ts");
const ajv = __webpack_require__(/*! ajv */ "./node_modules/ajv/lib/ajv.js");
const Subject_1 = __webpack_require__(/*! rxjs/internal/Subject */ "./node_modules/rxjs/internal/Subject.js");
let ValidationService = class ValidationService {
    constructor(itrSchema) {
        ...
        return new Promise((resolve, reject) => {
            if (this.tempFileNames.indexOf(uploadedFile.name) > -1) {
                reader.onloadend = (e) => {
                    ...
                    const errorData = this.ajvValidation.errors;
                    if (errorData) {
