 ...
 * 
 * @Service public class FileUploadKafkaConfiguration {
 * 
 * private static final Logger logger =
 * LoggerFactory.getLogger(FileUploadKafkaConfiguration.class);
 * 
 * @Autowired private KafkaTemplate<String, String> kafkaTemplate;
 * 
 * public void sendMessage(String jsonValidateFileKey) {
 * logger.info(String.format("$$ -> Producing message --> %s",
 * jsonValidateFileKey)); this.kafkaTemplate.send(FileConstants.JSON_VALIDATE,
 * jsonValidateFileKey); }
 * 
